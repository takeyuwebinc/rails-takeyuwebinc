class ServicesController < ApplicationController
  ...
  def find_services(key = nil)
    service_names = {
      "remote_team" => [ "レンタルチーム", "Webサービス開発", "UX/UI デザイン", "インフラ開発", "コードベース改善", "新規サービス開発", "保守開発" ],
      "technichal_advisor" => [ "技術顧問", "コードレビュー", "開発基盤改善", "Ruby on Rails アップグレード", "採用アドバイス", "チームビルディング", "システム設計" ],
      "outsourcing" => []
    }
    services = {
      ...
      "採用アドバイス" => { outline: "エンジニア人材の採用アドバイスをいたします。オンラインの採用面談に同席したり、求職者から提出された資料を現役のエンジニアの目から精査することで、候補者が持つ適性について判断しアドバイスを行います。", image: "undraw_online_friends_x73e.svg" },
      "チームビルディング" => { outline: "開発チームの状況をヒアリングし、課題の発見と解決のためのアドバイスを行います。\nアジャイル・スクラム導入のコーチング、開発チームとビジネスチームとの橋渡しなど、ビジネス目標達成ための様々な支援を行います。", image: "undraw-connecting-teams-3-1-pgn.svg" },
