Rails.application.reloader.to_prepare do
  ...
  class ActiveStorage::Blob
    ...
    validates :content_type, allow_nil: true, inclusion: { in: %w[image/png image/jpg image/jpeg image/gif application/x-zip-compressed application/pdf text/plain] }, if: :content_type_changed?
